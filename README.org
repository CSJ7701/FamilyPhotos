...
** Updating
If updates are made to this repo and you wish to update your server follow these steps:
- Stop the server by navigating to the directory where you saved your =docker-compose.yml= file, and run =docker compose down=.
